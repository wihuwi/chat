...
static constexpr auto qt_meta_stringdata_ZN8TimerBtnE = QtMocHelpers::stringData(
    "TimerBtn"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN8TimerBtnE[] = {
...
Q_CONSTINIT const QMetaObject TimerBtn::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8TimerBtnE.offsetsAndSizes,
    qt_meta_data_ZN8TimerBtnE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8TimerBtnE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TimerBtn, std::true_type>
    >,
    nullptr
} };
...
void *TimerBtn::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8TimerBtnE.stringdata0))
